...
class GuestUser_UserController extends Omeka_Controller_AbstractActionController
{
    ...
    protected function _sendConfirmationEmail($user, $token)
    {
        ...
        $body = __("Welcome to the %s community. Your registration has been successful, yet must be confirmed by following %s. Log in to comment on existing contributions and post stories and pictures of your own.", "<a href='$siteUrl'>$siteTitle</a>", "<a href='$url'>" . __('this link') . "</a>", $siteTitle);
